module.exports = {
    ...
    async execute (client, interaction) {
        ...
        interaction.user.id === target?.id || interaction.member.roles.cache.has(client.config.IDs.roles.mods) || interaction.member.roles.cache.has(client.config.IDs.roles.admins) ? interaction.message.delete().catch(err => client.error(err)) 
